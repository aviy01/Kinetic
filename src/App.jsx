...
import { Home, Apple, TrendingUp, Zap, User, Mail, Eye, EyeOff, Phone, Menu, LogOut, Settings, Download, Play, Pause, StopCircle, Search, Plus, X } from 'lucide-react';

// Inline Google SVG icon (not available in lucide-react)
const GoogleIcon = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ display: 'inline', verticalAlign: 'middle' }}>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-6" style={{ background: 'linear-gradient(135deg, #14B8A6 0%, #0D9488 100%)' }}>
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl space-y-4">
            ...
            <button onClick={() => handleLogin('google')} className="w-full py-3 border-2 border-teal-500 text-teal-600 rounded-lg font-semibold hover:bg-teal-50 transition"><GoogleIcon size={20} /> <span className="ml-2">Google</span></button>
